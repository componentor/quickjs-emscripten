...
[quickjs-emscripten](../../../packages.md) / [@componentor/quickjs-emscripten-core](../README.md) / JSModuleLoaderAsync

# Interface: JSModuleLoaderAsync()

Defined in: [packages/quickjs-emscripten-core/src/types.ts:74](https://github.com/componentor/quickjs-emscripten/blob/main/packages/quickjs-emscripten-core/src/types.ts#L74)

...
[quickjs-emscripten](../../../packages.md) / [@componentor/quickjs-ffi-types](../README.md) / EmscriptenModuleLoaderOptions

# Interface: EmscriptenModuleLoaderOptions

Defined in: [emscripten-types.ts:77](https://github.com/componentor/quickjs-emscripten/blob/main/packages/quickjs-ffi-types/src/emscripten-types.ts#L77)

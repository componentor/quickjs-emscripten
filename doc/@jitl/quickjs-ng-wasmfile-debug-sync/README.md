...
[quickjs-emscripten](../../packages.md) / @componentor/quickjs-ng-wasmfile-debug-sync
...
```typescript
import variant from "@componentor/quickjs-ng-wasmfile-debug-sync"
...
Defined in: [index.ts:18](https://github.com/componentor/quickjs-emscripten/blob/main/packages/variant-quickjs-ng-wasmfile-debug-sync/src/index.ts#L18)

### @componentor/quickjs-ng-wasmfile-debug-sync

[Docs](https://github.com/justjake/quickjs-emscripten/blob/main/doc/@componentor/quickjs-ng-wasmfile-debug-sync/README.md) |
Variant with separate .WASM file. Supports browser ESM, NodeJS ESM, and NodeJS CommonJS.

...
[quickjs-emscripten](../../packages.md) / @componentor/quickjs-singlefile-browser-debug-asyncify
...
```typescript
import variant from "@componentor/quickjs-singlefile-browser-debug-asyncify"
...
Defined in: [index.ts:18](https://github.com/componentor/quickjs-emscripten/blob/main/packages/variant-quickjs-singlefile-browser-debug-asyncify/src/index.ts#L18)

### @componentor/quickjs-singlefile-browser-debug-asyncify

[Docs](https://github.com/justjake/quickjs-emscripten/blob/main/doc/@componentor/quickjs-singlefile-browser-debug-asyncify/README.md) |
Variant with the WASM data embedded into a browser ESModule.

...
[quickjs-emscripten](../../packages.md) / @componentor/quickjs-singlefile-cjs-release-asyncify
...
```typescript
import variant from "@componentor/quickjs-singlefile-cjs-release-asyncify"
...
Defined in: [index.ts:18](https://github.com/componentor/quickjs-emscripten/blob/main/packages/variant-quickjs-singlefile-cjs-release-asyncify/src/index.ts#L18)

### @componentor/quickjs-singlefile-cjs-release-asyncify

[Docs](https://github.com/justjake/quickjs-emscripten/blob/main/doc/@componentor/quickjs-singlefile-cjs-release-asyncify/README.md) |
Variant with the WASM data embedded into a universal (Node and Browser compatible) CommonJS module.

...
See the [worker-pool package documentation](_media/README.md) for full API reference.
...
**Note:** WasmFS with OPFS is browser-only (OPFS is a browser API). For more details, see the [WasmFS variant documentation](_media/README-1.md) and [WasmFS Integration Guide](_media/WASMFS_INTEGRATION.md).
...
[setDebugMode]: _media/README-2.md#setdebugmode

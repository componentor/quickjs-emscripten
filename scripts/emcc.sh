...
# Cache sysroot libraries to avoid recompiling them in every container.
# NOTE: symbol_lists is intentionally NOT cached - it causes race conditions
# when parallel builds with SINGLE_FILE=1 and --closure 1 run simultaneously.
